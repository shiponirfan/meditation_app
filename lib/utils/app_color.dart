...
class AppColor {
  static Color primary = const Color(0xff8E97FD);
  static Color secondary = const Color(0xff3F414E);
  static Color ternary = const Color(0xffEBEAEC);
  static Color inputBg = const Color(0xffF2F3F7);
  static Color iconBg = const Color(0xffFFC97E);
